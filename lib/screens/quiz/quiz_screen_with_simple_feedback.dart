...
/// Beispiel: QuizScreen mit integriertem einfachen Feedback-Widget
/// Zeigt, wie das SimpleQuestionFeedbackWidget in bestehende Quiz-Screens integriert wird
class QuizScreenWithSimpleFeedback extends ConsumerStatefulWidget {
  const QuizScreenWithSimpleFeedback({super.key});

  @override
  ConsumerState<QuizScreenWithSimpleFeedback> createState() => _QuizScreenWithSimpleFeedbackState();
}

class _QuizScreenWithSimpleFeedbackState extends ConsumerState<QuizScreenWithSimpleFeedback> {
  ...
  Future<void> _loadQuestions() async {
    ...
    try {
      ...
      if (category == null) {
        questions = await quizService.getQuestionsFromAllCategories(questionCount, userId);
      } else {
        questions = await quizService.getQuestionsForSession(category.id, questionCount, userId);
      }
  ...
  Widget build(BuildContext context) {
    ...
    // Kategorie-Name für Feedback bestimmen
    final args = ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;
    final category = args['category'] as Category?;
      ...
      body: Column(
        children: [
          ...
          LinearProgressIndicator(
            value: progress,
            backgroundColor: isDarkMode ? AppColors.progressTrackDark : AppColors.border,
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // EINFACHES FEEDBACK-WIDGET HIER HINZUGEFÜGT
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: isDarkMode ? AppColors.primaryDark : AppColors.textPrimary,
  ...
  Widget _buildAnswerOption(Question question, int index) {
    ...
    if (_isAnswered) {
      if (isCorrectOption) {
        ...
        textColor = isDarkMode ? AppColors.successLight : AppColors.successDarkest;
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                color: isSelected ? backgroundColor : Theme.of(context).colorScheme.surface,
              ),
              child: isSelected
                  ? Center(
                      child: Container(
  ...
  void _submitAnswer() async {
    if (_selectedIndices.isEmpty) {
      final l10n = AppLocalizations.of(context)!;
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text(l10n.pleaseSelectAnswer)),
      );
      return;
    }
