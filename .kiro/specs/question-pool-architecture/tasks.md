...
- [ ] 1. Update data models and add sequence field to questions
...
- [ ] 2. Create enhanced QuestionState model for pool architecture
...
- [ ] 3. Create pool metadata model and service
...
- [ ] 4. Implement QuestionPoolService core functionality
...
- [ ]* 4.3 Write property test for count constraints
  - **Property 4: Count constraint satisfaction**
  - **Validates: Requirements 1.4**

- [ ] 5. Implement pool expansion functionality
...
- [ ]* 5.1 Write property test for pool expansion correctness
...
- [ ] 6. Implement answer recording with pool state updates
...
- [ ]* 6.1 Write property test for answer recording updates
  - **Property 5: Answer recording updates all fields**
  - **Validates: Requirements 3.1, 3.2, 3.3**

- [ ]* 6.2 Write property test for mastery threshold
  - **Property 6: Mastery threshold enforcement**
  - **Validates: Requirements 3.4**

- [ ] 7. Add data consistency and error handling
...
- [ ]* 7.2 Write property test for partial failure consistency
  - **Property 8: Partial failure consistency**
  - **Validates: Requirements 4.3**

- [ ]* 7.3 Write property test for required fields completeness
...
- [ ] 9. Create Firestore indexes for optimal performance
...
- [ ] 11. Update QuizService to use QuestionPoolService
