...
import 'package:babycation/services/friends_service.dart';
import 'package:babycation/models/user_model.dart';
import 'package:babycation/models/friend.dart';
import 'dart:math';
  ...
  group('FriendsService', () {
    ...
    Future<UserModel> createTestUser({
      ...
      final user = UserModel(
        ...
        streakCurrent: 0,
        streakLongest: 0,
        duelsPlayed: duelsWon + duelsLost,
        duelsWon: duelsWon,
        duelsLost: duelsLost,
        duelPoints: duelsWon * 3,
      );
